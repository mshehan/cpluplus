...
int main()
{
    ...
    cout << "let's start. Please enter the string you would like to edit: " << endl;
    ...
    do
    {
      ...
      switch(choice)
      {
        case 1: // inserts character
          ...
          cout<< "you've chosen to insert a character at the " 
            << "cursor's position" << endl;
        ...
        case 6: // deletes char ahead of cursor
            ...
            cout << "you've chosen to delete the character directly "
              << "following the cursor" << endl;
...
void printMenu()
{
    ...
    cout << "7: backspace (remove) the character directly preceding the cursor" << endl;

...
void list_tail_remove(node*& headptr)
{
    ...
    previous_ptr = headptr;
    remove_ptr = getLast(headptr);
    
    if(previous_ptr != remove_ptr)
    {
      while(previous_ptr -> link() != remove_ptr)
